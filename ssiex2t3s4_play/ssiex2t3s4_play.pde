...
void buildHandShape() {
  ...
  fill(#ff0000);
  drawCylinder(10, 0, d * 0.8, hand_size * 0.19);
  fill(#888888);
  popMatrix();
  ...
  drawCylinder(10, 0, d, hand_size * 0.37);
  popMatrix();
  ...
  drawCylinder(10, 0, d * 1.1, hand_size * 0.45);
  popMatrix();
  ...
  rotateY( - PI * 0.01);
  translate( - hand_size * 0.08, 0, hand_size * 0.11);
  drawCylinder(10, 0, d, hand_size * 0.39);
  popMatrix();
